 ...
 * @NScriptType Restlet
 *
 * SB endpoint:https://1116623-sb2.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=5713&deploy=1
 */
        ...
        const post = (requestBody) =>
        {
            ...
            try
            {
                ...
                respMsg = {
                    success:true,
                    requestBody,
                    addtl_note:"hello your integration message was received, timestamp: " + new Date().getTime()
                }
            }
            catch(e)
            {
